...
import { FaDumbbell, FaTachometerAlt, FaCalendarAlt, FaCheckSquare, FaClipboardList, FaSignOutAlt, FaUser, FaHome } from 'react-icons/fa';
        ...
        <div style={styles.container}>
            ...
            <div style={styles.main}>
                <header style={styles.header}>
                    <span style={styles.headerTitle}>ÁREA DE INSTRUCTORES</span>
